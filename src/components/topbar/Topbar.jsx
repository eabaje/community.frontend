  ...
  return (
    <>
      ...
      <div class="navbar-area">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <div class="notifications-body" data-simplebar>
                        ...
                        <div class="view-all-notifications-btn">
                          <a href="notifications.html" class="default-btn">
        ...
        <div class="others-link-for-responsive">
          <div class="container">
            <div class="dot-menu">
              <div class="inner">
            ...
            <div class="container">
              <div class="option-inner">
                <div class="others-options d-flex align-items-center">
                  <div class="option-item">
                    <a href="index.html" class="home-btn white-font">
                      <i class="flaticon-home"></i> Find Maternal Links
                    </a>
                  </div>
                </div>
              </div>
